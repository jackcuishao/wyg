    ...
    FileInput.prototype = {
        ...
        uploadSingle: function (i, files, allFiles) {
            ...
            fnSuccess = function (data, textStatus, jqXHR) {
                console.log(data);
                self.vid = data.vid;
                if(typeof($("#file-Path").attr("multiple"))=="undefined"){
                    $("#imgurl").val(data.picStr);
                }else{
                    picArry.push(data.picStr);
                }
            ...
            formdata.append('work',self.work);
            formdata.append('workid',self.workid);
            formdata.append('filename',self.filename);
            formdata.append('tos',self.tos);
            formdata.append('iid',self.iid);
            formdata.append('teamid',self.teamid);
            formdata.append('orderid',self.orderid);
            formdata.append('gid',self.gid);
